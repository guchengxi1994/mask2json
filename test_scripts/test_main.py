...
LastEditTime: 2020-10-16 14:49:50
'''
import sys
sys.path.append("..")
import os
...
if __name__ == "__main__":
    ...
    code = 'python {} augmentation -i {} '.format(oriImgPath1, labelPath1)
    os.system(code)

    code = 'python {} augmentation -i {}  -N 20 --labelImg'.format(oriImgPath2, labelPath2)
    os.system(code)
