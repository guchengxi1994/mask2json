...
LastEditTime: 2020-11-20 13:58:05
'''
import sys
...
from convertmask.utils.auglib.optional.mosaic import mosiac_img,mosiacScript,mosiac_img_no_reshape
...
if __name__ == "__main__":
    ...
    mosicImg,_ = mosiac_img_no_reshape([oriImg,oriImg,oriImg,oriImg],heightFactor=0.4, widthFactor=0.3)
    io.imsave(imgPath,mosicImg)